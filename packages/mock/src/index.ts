...
import marketSummaryData from './market-summary.json';
...
export { default as marketSummaryMock } from './market-summary.json';
export { default as stocksMock } from './stocks.json';